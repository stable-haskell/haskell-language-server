      ...
      viArch:
        A_64:
          ...
          Linux_Mint:
            ...
            '(>= 20 && < 21)':
              dlUri: $baseUrl/haskell-language-server-$RELEASE-x86_64-linux-mint20.2.tar.xz
              dlSubdir: haskell-language-server-$RELEASE
          ...
          Linux_UnknownLinux:
            unknown_versioning:
              dlUri: $baseUrl/haskell-language-server-$RELEASE-x86_64-linux-unknown.tar.xz
              dlSubdir: haskell-language-server-$RELEASE
          ...
          FreeBSD:
            unknown_versioning:
              dlUri: $baseUrl/haskell-language-server-$RELEASE-x86_64-freebsd.tar.xz
              dlSubdir: haskell-language-server-$RELEASE
